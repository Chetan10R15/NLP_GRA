...
Handles:
- English: Brown corpus loaded from NLTK with 80/20 train/test split.
- German: UD German-GSD loaded via conllu with official train, dev, and test splits.
- Vocabulary building and token/tag extraction for standard and morphology-aware tags.
"""
