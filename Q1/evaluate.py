...
Criterion 6: Evaluation (accuracy + confusion matrix + error-source breakdown) (15 Marks)

Implements:
- Alignment of gold vs predicted word spans via character offsets.
- Word segmentation precision, recall, and F1/accuracy.
- POS tagging accuracy.
- Separation of error sources:
  1. Segmentation-caused tagging errors (incorrect word boundary propagated to tagger).
  2. Genuine tagging errors (word correctly segmented, but wrong tag assigned).
- Confusion matrix generation and CSV export.
- Evaluation of sample benchmark sentences.
"""
