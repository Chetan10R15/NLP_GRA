...
Implements:
- English: Brown corpus tag conversion to morphology-aware tags (Gender/Number/Tense).
- German: UD feature composition (UPOS + Gender + Number + Case) for agreement modeling.
"""
