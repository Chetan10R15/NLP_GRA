"""
Q1: Word Segmentation and POS Tagging - Main Runner
Executes full pipeline for both English and German, runs baselines,
generates confusion matrices, formats sample string outputs, and saves
structured output files to Q1/outputs/ for report generation.
"""
import os
import sys
import pandas as pd
