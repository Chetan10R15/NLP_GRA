...
Criterion 2: Segmentation model (trigram + DP)
Implements:
- Trigram Language Model (unigram, bigram, trigram counts with Jelinek-Mercer smoothing).
- Character-level Viterbi Dynamic Programming decoder to find the optimal word segmentation.
"""
import math
