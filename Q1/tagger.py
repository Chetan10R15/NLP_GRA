...
Criterion 3: POS tagging model (emission + transition) (15 Marks)
Implements:
- Trigram HMM Tagger computing emission and transition probabilities.
- Dynamic programming Viterbi decoder with candidate tag pruning for fast, accurate decoding.
"""
import math
