...
and real-word errors within an edit distance of 1.

- Part 0 : Setup
- Part 1 : Corpus and Model Preparation
- Part 2 : Candidate Generation (Method A: edit distance 1, Method B: Symmetric Delete Spelling Correction)
- Part 3 : Spelling Correction Logic (non-word / real-word correction)
